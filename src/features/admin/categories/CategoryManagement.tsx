        ...
        {categories.map((category) => (
          ...
          >
            ...
            <div className="flex gap-2 mt-auto pt-4">
              <button className="flex-1 h-10 rounded-lg bg-[#f4ede6] dark:bg-white/10 text-gray-900 dark:text-white text-sm font-bold flex items-center justify-center hover:bg-orange-100 dark:hover:bg-orange-500/20 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-[#2c2219] rounded-xl shadow-2xl border border-[#f4ede6] dark:border-white/10 flex flex-col overflow-hidden">
            <div className="p-6 border-b border-[#f4ede6] dark:border-white/10 flex justify-between items-center">
              <h2 className="text-gray-900 dark:text-white text-xl font-bold">Add New Category</h2>
              <button
